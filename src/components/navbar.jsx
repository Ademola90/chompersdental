...
const Navbar = () => {
  ...
  return (
    <header
      className={`w-full fixed top-0 z-50 transition-all duration-300 lg:px-10 md:px-10 px-5 ${
        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            <div className="relative" onClick={handleDropdownClick}>
              ...
              {isServicesOpen && (
                <div className="absolute top-full left-0 mt-2 w-64 bg-white shadow-lg rounded-md overflow-hidden z-20">
                  <div className="py-1">
                    {/* Children option */}
                    <ServiceLink
                    ...
                    <div className="relative">
                      ...
                      {isOrthodonticsOpen && (
                        <div className="absolute left-full top-0 w-64 bg-white shadow-lg rounded-md overflow-hidden z-30">
                          <ServiceLink
